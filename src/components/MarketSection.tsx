...
const MarketSection = () => {
    ...
    return (
        <section id="opportunity" className="py-16 md:py-32">
            <div className="section-wrap">
                ...
                <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-start">
                    ...
                    >
                        <p className="text-[15px] text-[#3a3830] leading-relaxed">
                        ...
                        <div className="pt-6 md:pt-8 border-t border-[var(--rule)]">
                            <div className="font-mono text-[10px] text-[var(--gold)] uppercase tracking-widest mb-4 md:mb-6">Partner Identity</div>
                            <div className="grid grid-cols-2 gap-3 md:gap-4">
                                {[
                                    ...
                                    <div key={item.label}>
                                        <div className="text-[13px] md:text-[14px] font-bold text-[var(--ink)]">{item.label}</div>
                                        <div className="text-[10px] md:text-[11px] text-[var(--muted)] uppercase tracking-wider">{item.sub}</div>
                                    </div>
                                ))}
                            </div>
                        </div>
                    ...
                    <motion.div
                        className="flex flex-col gap-5 md:gap-7 order-1 md:order-2"
                        initial={{ opacity: 0, x: 20 }}
                        whileInView={{ opacity: 1, x: 0 }}
                        viewport={{ once: true }}
